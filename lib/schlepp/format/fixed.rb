module Schlepp
  module Format
    # Uses unpack from String to parse fixed length files
    class Fixed < Base
      ...
      #should be a string that can be dumped into String#unpack
      ...
      # runs a string through the String#unpack.
      def parse(data) # :nodoc:
        the_array = []
        data.each_line do |line|
          the_array << line.unpack(field_definition)
        end
        the_array
      end
